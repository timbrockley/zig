...
//--------------------------------------------------------------------------------
extern fn queryCallback(db_handle: ?*anyopaque, sql: [*c]const u8, columns: *?[*]SQLiteColumn, column_count: *usize, callback: ?*const fn (?*anyopaque, [*]SQLiteColumn, usize) callconv(.c) c_int, ctx: ?*anyopaque, errmsg: *?[*:0]u8) callconv(.c) c_int;
...
extern fn sqliteOpen(filepath: [*:0]const u8, db_handle: *?*anyopaque, errmsg: *?[*:0]u8) callconv(.c) c_int;
...
pub fn main(init: std.process.Init) !u8 {
    ...
    //--------------------------------------------------------------------------------
    {
        ...
        const rc = sqliteOpen(DATABASE_FILEPATH, &db_handle, &errmsg);
